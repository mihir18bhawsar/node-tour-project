...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWFwYm94LS1taWhpciIsImEiOiJja3Y0dzNyOWUwa2RuMm9wZ2k0MzdxOXR3In0.Cl3qJ-4VYAx4D3qjqaxzKQ'; // create new map and integrate
  ...
  var bounds = new mapboxgl.LngLatBounds(); // set marker element and set its coordinates and add to map
  ...
  locations.forEach(function (loc) {
    ...
    .addTo(map); // add new popup for this marker location
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            res = _context.sent;
            if (res.data.status === 'success') (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " Successfully Updated"));
            _context.next = 11;
            break;
...
var stripe = Stripe('pk_test_51JrIGqSJJjZ6nVgZQfLgVbFnYXI11AKOQd1vqDeVuL6BDipu8zNX8kucpRlji4MYZAzvbYzF0tNx6LqQX5Mp1EW8003ZzZViMQ');
...
var loginForm = document.querySelector('.formL');
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "35803" + '/');
